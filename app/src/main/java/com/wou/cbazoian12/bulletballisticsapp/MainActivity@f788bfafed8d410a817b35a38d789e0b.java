...
public class MainActivity extends ActionBarActivity  {
    ...
    private Button calcButtonClick;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(validateInput(distanceToTarget) == true)
                {
                    //turn string version of input into an int
                    int distance = Integer.parseInt(distanceToTarget);
                    ...
                    else
                    {
                        ...
                        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
                        {
                            ...
                            public void onCheckedChanged(RadioGroup group, int checkedId)
                            {
                                ...
                                //if .22 is selected...
                                if(checkedRadioButton.getText() == "bulletType1")
                                {
                                    bulletVelocity = 1280;
                                }
                                //if .50BMG is selected...
                                else if(checkedRadioButton.getText() == "bulletType8")
                                {
                                    bulletVelocity = 2900;
                                }
                                else
                        ...
                        //set the results as the input for testing purposes
